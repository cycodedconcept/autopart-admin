...
const CategoryDistribution: React.FC = () => {
  ...
  const [data, setData] = useState<CategoryData[]>([
    { name: 'Brake parts', value: 340, colorClass: 'bg-aorange', strokeColor: '#FF7101' },
    { name: 'Engine parts', value: 280, colorClass: 'bg-[#7ED321]', strokeColor: '#7ED321' },
    { name: 'Electrical', value: 190, colorClass: 'bg-[#10B981]', strokeColor: '#10B981' },
    { name: 'Body parts', value: 110, colorClass: 'bg-purple-500', strokeColor: '#a855f7' },
    { name: 'Other', value: 80, colorClass: 'bg-[#A78BFA]', strokeColor: '#A78BFA' },
  ]);
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-3  gap-4 w-full">
      ...
      <div className="bg-white px-4 py-5 rounded-lg border border-lightborder w-full flex flex-col items-center justify-between min-h-50">
          <h3 className="text-dark font-medium text-sm self-start w-full">Revenue by Category</h3>
          
          <div className="relative w-32 h-32 flex items-center justify-center my-auto">
            <svg className="w-full h-full transform -rotate-90" viewBox="0 0 36 36">
              {/* Grey Track Ring */}
              <circle cx="18" cy="18" r="14.5" fill="none" stroke="#f3f4f6" strokeWidth="7" />
