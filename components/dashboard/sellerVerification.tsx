import { DashboardVerificationSeller } from "@/types/verification";
import { CardWrapper } from "../ui/cardWrapper";

export interface SellerVerificationCardProps {
  data: DashboardVerificationSeller[];
  onViewAll?: () => void;
}
        ...
        <tbody className="text-sm font-normal text-navgray">
          {data.map((item, idx) => (
            ...
            >
              ...
              <td className="py-3">
                <span
                  className={`px-2 py-1 w-full block rounded-[20px] text-[11px] font-medium text-[#633806] bg-[#FAEEDA] `}
                >
